...
const FourTriangles = ({player1, player2, player3, player4}) => {
    ...
    () => [
      {
        ...
        top: 55,
        left: 15,
        pieceColor: playerColors.player1,
      ...
      },
      {
        ...
        top: 52,
        left: 15,
        pieceColor: playerColors.player3,
        translate: 'translateX',
      },
      {
        player: player2,
        top: 20,
        left: -2,
        pieceColor: playerColors.player2,
      ...
      },
      {
        ...
        top: 55,
        right: -2,
        pieceColor: playerColors.player4,
        translate: 'translateX',
      },
    ],
  ...
  const renderPlayerPieces = useCallback((data, index) => (
    <PlayerPieces
      ...
      translate={data.translate}></PlayerPieces>
  ));
